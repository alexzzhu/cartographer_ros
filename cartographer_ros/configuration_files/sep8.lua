...
TRAJECTORY_BUILDER_2D.submaps.resolution = 0.25
...
TRAJECTORY_BUILDER_3D.ceres_scan_matcher.translation_weight = 1e0
TRAJECTORY_BUILDER_3D.ceres_scan_matcher.rotation_weight = 1e0
TRAJECTORY_BUILDER_3D.min_range = 2
TRAJECTORY_BUILDER_3D.max_range = 120
TRAJECTORY_BUILDER_3D.submaps.high_resolution_max_range = 120
...
--TRAJECTORY_BUILDER_3D.imu_gravity_time_constant = 25
...
SPARSE_POSE_GRAPH.matcher_rotation_weight = 5e6
--SPARSE_POSE_GRAPH.matcher_translation_weight = 5e6
--SPARSE_POSE_GRAPH.constraint_builder.sampling_ratio = 0.3
SPARSE_POSE_GRAPH.constraint_builder.max_constraint_distance = 120
...
SPARSE_POSE_GRAPH.constraint_builder.loop_closure_translation_weight = 1e4
SPARSE_POSE_GRAPH.constraint_builder.loop_closure_rotation_weight = 1e3
...
--SPARSE_POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher_3d.linear_z_search_window = 60
...
--SPARSE_POSE_GRAPH.optimization_problem.acceleration_weight = 1e3
